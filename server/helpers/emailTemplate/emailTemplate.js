 ...
 */
const emailTemplate = (name, buttonText, message, link, icon) => (
  `
          ...
          <tr>
            <table>
              <tbody>
                <tr>
                  <td>
                  <i class="fa fa-unlock-alt fa-5x" aria-hidden="true" width="72px"/>
                    <i class=${icon} aria-hidden="true" width="72px"/>
                  </td>
                </tr>
                <tr>
                  <td>
