...
import ChangePasswordModal from '../../../../src/commonViews/userSection/ChangePasswordModal.jsx';
...
describe('<ChangePasswordModal', () => {
  it('renders ChangePasswordModal component without crashing if error props is null', () => {
    const wrapper = setup();
